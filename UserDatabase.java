/**
   ...
   */
public class UserDatabase extends Database implements IEditableDatabase {
	
	/**
	   * Initialize the variables. Initialize the records[] array for storing User records
	   */
	public UserDatabase() {
		super();
		this.records = new User[this.MAX_RECORDS];
